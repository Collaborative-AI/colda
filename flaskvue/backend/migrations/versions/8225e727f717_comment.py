...
Revision ID: 8225e727f717
Revises: 
Create Date: 2022-01-11 16:31:47.128609
...
def upgrade():
    ...
    sa.Column('Matched_id_file', sa.Text(10000000), nullable=True),
    ...
    sa.Column('situation', sa.Text(10000000), nullable=True),
    sa.Column('output', sa.Text(10000000), nullable=True),
    sa.Column('test_indicator', sa.String(length=10), nullable=True),
    sa.Column('test_id', sa.String(length=120), nullable=True),
    ...
    sa.Column('payload_json', sa.Text(10000000), nullable=True),
    sa.Column('sender_random_id_list', sa.Text(10000000), nullable=True),
    sa.Column('task_id_list', sa.Text(10000000), nullable=True),
