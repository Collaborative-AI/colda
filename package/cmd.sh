...
# local
./dist/run/run make_train_local --root ./exp --self_id 0 --task_id abc --data_path ./data/BostonHousing/2/123/1.0/0/train/data.csv --target_path ./data/BostonHousing/2/123/1.0/0/train/target.csv
./dist/run/run make_test_local --root ./exp --self_id 0 --task_id abc --test_id kdg --data_path ./data/BostonHousing/2/123/1.0/0/test/data.csv --target_path ./data/BostonHousing/2/123/1.0/0/test/target.csv

# default
# hash id
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/0/all/id.csv --root ./exp --self_id 0 --mode default
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/1/all/id.csv --root ./exp --self_id 1 --mode default

# Train
# hash id
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/0/train/id.csv --root ./exp --self_id 0 --task_id abc --mode train
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/1/train/id.csv --root ./exp --self_id 1 --task_id abc --mode train
...
# round 0
# make residual
./dist/run/run make_residual --root ./exp --self_id 0 --task_id abc --round 0 --target_path ./data/BostonHousing/2/123/1.0/0/train/target.csv
...
# train
./dist/run/run make_train --root ./exp --self_id 0 --task_id abc --round 0 --data_path ./data/BostonHousing/2/123/1.0/0/train/data.csv
./dist/run/run make_train --root ./exp --self_id 1 --task_id abc --round 0 --from_id 0 --data_path ./data/BostonHousing/2/123/1.0/1/train/data.csv
...
./dist/run/run make_result --root ./exp --self_id 0 --task_id abc --round 0 --target_path ./data/BostonHousing/2/123/1.0/0/train/target.csv

# round 1
# make residual
./dist/run/run make_residual --root ./exp --self_id 0 --task_id abc --round 1 --target_path ./data/BostonHousing/2/123/1.0/0/train/target.csv
...
# train
./dist/run/run make_train --root ./exp --self_id 0 --task_id abc --round 1 --data_path ./data/BostonHousing/2/123/1.0/0/train/data.csv
./dist/run/run make_train --root ./exp --self_id 1 --task_id abc --round 1 --from_id 0 --data_path ./data/BostonHousing/2/123/1.0/1/train/data.csv
...
./dist/run/run make_result --root ./exp --self_id 0 --task_id abc --round 1 --target_path ./data/BostonHousing/2/123/1.0/0/train/target.csv

# Test
# hash id
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/0/test/id.csv --root ./exp --self_id 0 --task_id abc --mode test --test_id def
./dist/run/run make_hash --id_path ./data/BostonHousing/2/123/1.0/1/test/id.csv --root ./exp --self_id 1 --task_id abc --mode test --test_id def
...
# test
./dist/run/run make_test --root ./exp --self_id 0 --task_id abc --test_id def --round 1 --data_path ./data/BostonHousing/2/123/1.0/0/test/data.csv
./dist/run/run make_test --root ./exp --self_id 1 --task_id abc --test_id def --round 1 --from_id 0 --data_path ./data/BostonHousing/2/123/1.0/1/test/data.csv
...
# eval
./dist/run/run make_eval --root ./exp --self_id 0 --task_id abc --test_id def --round 1 --target_path ./data/BostonHousing/2/123/1.0/0/test/target.csv
