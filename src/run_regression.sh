...
python run.py make_hash --root ./exp --self_id 1 --task_id abc --mode train --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --id_idx 1
...
python run.py make_train --root ./exp --self_id 1 --task_id abc --round 1 --from_id 0 --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
python run.py make_train --root ./exp --self_id 1 --task_id abc --round 2 --from_id 0 --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
python run.py make_hash --root ./exp --self_id 1 --task_id abc --mode test --test_id def --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --id_idx 1
...
python run.py make_test --root ./exp --self_id 1 --task_id abc --test_id def --round 2 --from_id 0 --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7
