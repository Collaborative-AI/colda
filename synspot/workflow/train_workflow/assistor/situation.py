...
class TrainAssistorSituation:
    ...
    @classmethod
    def unread_situation_assistor_train_part(cls, task_id: str, rounds: int, from_id: str, train_file_path: str, train_data_column: str, task_mode: str, model_name: str, waiting_start_time: float):
