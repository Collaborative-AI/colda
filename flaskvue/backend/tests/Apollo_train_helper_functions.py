...
class Train_Helper_API_TestCase(unittest.TestCase):
    ...
    def unread_request_two_users_helper(self):
    ...
    def unread_match_id_two_users_helper(self):
    ...
    def unread_situation_two_users_helper(self, test_round):
    ...
    def unread_output_two_users_helper(self, test_round):
        task_id, list_content, assistor_random_id_list = self.unread_situation_two_users_helper(test_round)
