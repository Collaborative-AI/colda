            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="d-flex align-items-center">
                     <ModeSwitch/>
                     <h4 class="current-time text-primary mr-md-4 mr-3">{{ time }}</h4>
                   ...
                   <b-collapse id="nav-collapse" is-nav>
                        <ul class="navbar-nav align-items-center ml-auto navbar-list">
                           ...
                           <li class="nav-item nav-icon search-content"  v-nav-toggle>
                              <a href="#" class="search-toggle  dropdown-toggle box-square bg-danger-light" id="dropdownSearch" data-toggle="dropdown"
