<template>
   ...
   <div class="iq-navbar-custom">
      <div class=" d-flex align-items-center justify-content-between "> 
         ...
         <div class="iq-menu-horizontal d-flex align-items-center">            
            <nav class="iq-sidebar-h-menu">
               <ul id="iq-sidebar-toggle1" class="iq-menu d-flex">
                  <li class="active">
                     <router-link to="/" class=""><span>Home</span></router-link>
                  </li>
                  <li>
                     <router-link :to="{name: 'backend.layout-12'}" class="" ><span>salon</span></router-link>
                  </li>
                  <li>
                     <router-link :to="{ name: 'app.email-listing'}" class=""><span>Email</span></router-link>
                  </li>
                  <li>
                     <router-link :to="{name: 'app.chat'}" class=""><span>Chat</span></router-link>
                  </li> 
               </ul>
            </nav>
         </div>
            ...
            <b-collapse id="nav-collapse" is-nav>
               <ul class="navbar-nav ml-auto navbar-list align-items-center">  
                  <li class="nav-item nav-icon">
                     <a href="" class="btn btn-primary text-white apoin-btn d-flex align-items-center"><i class="ri-add-line"></i><span>Appointment</span></a>
                  </li>
