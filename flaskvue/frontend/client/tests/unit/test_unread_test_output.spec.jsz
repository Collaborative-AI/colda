...
import { unread_test_sponsor_match_id_helper} from './helper_folder/Apollo_unread_sponsor_test_match_id_helper'
import { unread_test_assistor_match_id_helper} from './helper_folder/Apollo_unread_assistor_test_match_id_helper'
import { unread_test_output_helper } from './helper_folder/Apollo_unread_test_output_helper';
...
describe('test_unread_test_request', () => {
  ...
  unread_test_output_helper.unread_test_output()
  //sponsor logouts
  logout_helper.logout()
