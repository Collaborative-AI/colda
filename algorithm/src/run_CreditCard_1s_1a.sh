...
# baseline
python baseline.py --root ./data/processed/CreditCard --data_name CreditCard --task_id 123 --num_users 1 --match_rate 1 --task_mode classification --model_name linear --metric_name Loss_Accuracy_F1_AUCROC
python baseline.py --root ./data/processed/CreditCard --data_name CreditCard --task_id 123 --num_users 2 --match_rate 1 --task_mode classification --model_name linear --metric_name Loss_Accuracy_F1_AUCROC
python baseline.py --root ./data/processed/CreditCard --data_name CreditCard --task_id 123 --num_users 2 --match_rate 0.5 --task_mode classification --model_name linear --metric_name Loss_Accuracy_F1_AUCROC

# local
python run.py make_train_local --root ./exp --self_id 0 --task_id xyz --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/train/dataset.csv --data_idx 2-16 --target_idx 17 --task_mode classification --model_name linear --metric_name Loss_Accuracy_F1_AUCROC
python run.py make_test_local --root ./exp --self_id 0 --task_id xyz --test_id uvw --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/test/dataset.csv --data_idx 2-16 --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC
...
# round 1
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id xyz --round 1 --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/train/dataset.csv --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC
...
python run.py make_result --root ./exp --self_id 0 --task_id xyz --round 1 --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/train/dataset.csv --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC

# round 2
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id xyz --round 2 --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/train/dataset.csv --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC
...
python run.py make_result --root ./exp --self_id 0 --task_id xyz --round 2 --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/train/dataset.csv --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC
...
# eval
python run.py make_eval --root ./exp --self_id 0 --task_id xyz --test_id uvw --round 2 --dataset_path ./data/processed/CreditCard/CreditCard_2_123_1.0/0/test/dataset.csv --target_idx 17 --task_mode classification --metric_name Loss_Accuracy_F1_AUCROC
