...
python make_dataset.py --root ./data/processed/Wine --data_name Wine --task_id 123 --num_users 2 --match_rate 1 --normalize 1
...
# default
# hash id
python run.py make_hash --root ./exp --self_id 0 --mode default --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/all/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --mode default --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --id_idx 1

# Train
# hash id
python run.py make_hash --root ./exp --self_id 0 --task_id xyz --mode train --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/train/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --task_id xyz --mode train --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --id_idx 1
...
# train
python run.py make_train --root ./exp --self_id 0 --task_id xyz --round 1 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --task_mode regression --model_name linear
python run.py make_train --root ./exp --self_id 1 --task_id xyz --round 1 --from_id 0 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
# train
python run.py make_train --root ./exp --self_id 0 --task_id xyz --round 2 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --task_mode regression --model_name linear
python run.py make_train --root ./exp --self_id 1 --task_id xyz --round 2 --from_id 0 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
# Test
# hash id
python run.py make_hash --root ./exp --self_id 0 --task_id xyz --mode test --test_id uvw --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/test/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --task_id xyz --mode test --test_id uvw --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --id_idx 1
...
# test
python run.py make_test --root ./exp --self_id 0 --task_id xyz --test_id uvw --round 2 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/0/test/dataset.csv --data_idx 2-8
python run.py make_test --root ./exp --self_id 1 --task_id xyz --test_id uvw --round 2 --from_id 0 --dataset_path ./data/processed/Wine/Wine_2_123_1.0/1/all/dataset.csv --data_idx 2-7
