...
class Database_class():
    ...
    def store_User_Sponsor_Table(self, user_id: str, task_id: str, test_indicator: str, task_mode: str, model_name: str, metric_name: str, test_id: str=None, 
        ...
        try:
            ...
            if key not in self.temp_database:
                self.temp_database[key] = collections.defaultdict(dict)
    ...
    def store_User_Assistor_Table(self, user_id: str, task_id: str, test_indicator: str, mode: str, task_mode: str, model_name: str, test_id: str=None, 
        ...
        try:
            ...
            self.temp_database[key]['User_Assistor_Table']['user_id'] = user_id
            self.temp_database[key]['User_Assistor_Table']['task_id'] = task_id
            self.temp_database[key]['User_Assistor_Table']['test_id'] = test_id
            self.temp_database[key]['User_Assistor_Table']['task_name'] = task_name
            self.temp_database[key]['User_Assistor_Table']['task_description'] = task_description
            self.temp_database[key]['User_Assistor_Table']['test_name'] = test_name
            self.temp_database[key]['User_Assistor_Table']['test_description'] = test_description
            self.temp_database[key]['User_Assistor_Table']['test_indicator'] = test_indicator

            self.temp_database[key]['User_Assistor_Table']['train_file_path'] = train_file_path
            self.temp_database[key]['User_Assistor_Table']['train_id_column'] = train_id_column
            self.temp_database[key]['User_Assistor_Table']['train_data_column'] = train_data_column
            self.temp_database[key]['User_Assistor_Table']['test_file_path'] = test_file_path
            self.temp_database[key]['User_Assistor_Table']['test_id_column'] = test_id_column
