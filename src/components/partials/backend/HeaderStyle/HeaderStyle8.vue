<template>
    <div class="iq-top-navbar">
            <div class="iq-navbar-custom rounded">
               <nav class="navbar navbar-expand-lg navbar-light p-0">   
                  ...
                  <div class="d-flex align-items-center div-space">
                     <ModeSwitch/>
                      ...
                      <b-collapse id="nav-collapse" is-nav>
                        <ul class="navbar-nav ml-auto navbar-list align-items-center">
                           ...
                           <li class="nav-item nav-icon">
                              <a href="" class="btn btn-primary text-white apoin-btn d-flex align-items-center"><i
                                    class="ri-add-line"></i><span>Add Property</span></a>
                           </li>
                           <li class="nav-item nav-icon search-content"  v-nav-toggle>
                              <a href="#" class="search-toggle text-gray rounded dropdown-toggle" id="dropdownSearch" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="card-body p-0 ">
                                       ...
                                       <div class="p-3">
                                          ...
                                          <a href="#" class="iq-sub-card" >
                                             <div class="media align-items-center">
                                                <div class="">
                                                   <img class="avatar-40 rounded-small" src="@/assets/images/user/05.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
