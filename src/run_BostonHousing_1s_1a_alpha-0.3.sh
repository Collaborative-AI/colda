...
python make_dataset.py --root ./data/processed/BostonHousing --data_name BostonHousing --task_id 123 --num_users 2 --match_rate 1 --normalize 1
...
# default
# hash id
python run.py make_hash --root ./exp --self_id 0 --mode default --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/all/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --mode default --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --id_idx 1

# Train
# hash id
python run.py make_hash --root ./exp --self_id 0 --task_id abc --mode train --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --task_id abc --mode train --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --id_idx 1
...
# train
python run.py make_train --root ./exp --self_id 0 --task_id abc --round 1 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --task_mode regression --model_name linear
python run.py make_train --root ./exp --self_id 1 --task_id abc --round 1 --from_id 0 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
python run.py make_result --root ./exp --self_id 0 --task_id abc --round 1 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name Loss_MAD_RMSE_R2 --assistance_rate_mode 0.3
...
# train
python run.py make_train --root ./exp --self_id 0 --task_id abc --round 2 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --task_mode regression --model_name linear
python run.py make_train --root ./exp --self_id 1 --task_id abc --round 2 --from_id 0 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7 --task_mode regression --model_name linear
...
python run.py make_result --root ./exp --self_id 0 --task_id abc --round 2 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name Loss_MAD_RMSE_R2 --assistance_rate_mode 0.3

# Test
# hash id
python run.py make_hash --root ./exp --self_id 0 --task_id abc --mode test --test_id def --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/test/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --task_id abc --mode test --test_id def --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --id_idx 1
...
# test
python run.py make_test --root ./exp --self_id 0 --task_id abc --test_id def --round 2 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/0/test/dataset.csv --data_idx 2-8
python run.py make_test --root ./exp --self_id 1 --task_id abc --test_id def --round 2 --from_id 0 --dataset_path ./data/processed/BostonHousing/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7
