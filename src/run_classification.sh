# make dataset
python make_dataset.py --root ./data --data_name Wine --task_id 123 --num_users 1 --match_rate 1
python make_dataset.py --root ./data --data_name Wine --task_id 123 --num_users 2 --match_rate 1
python make_dataset.py --root ./data --data_name Wine --task_id 123 --num_users 2 --match_rate 0.5

# baseline
python baseline.py --root ./data --data_name Wine --task_id 123 --num_users 1 --match_rate 1 --task_mode classification --model_name linear --metric_name Accuracy_F1
python baseline.py --root ./data --data_name Wine --task_id 123 --num_users 2 --match_rate 1 --task_mode classification --model_name linear --metric_name Accuracy_F1
python baseline.py --root ./data --data_name Wine --task_id 123 --num_users 2 --match_rate 0.5 --task_mode classification --model_name linear --metric_name Accuracy_F1

# local
python run.py make_train_local --root ./exp --self_id 0 --task_id xyz --dataset_path ./data/Wine_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --target_idx 9 --task_mode classification --model_name linear --metric_name Accuracy_F1
python run.py make_test_local --root ./exp --self_id 0 --task_id xyz --test_id uvw --dataset_path ./data/Wine_2_123_1.0/0/test/dataset.csv --data_idx 2-8 --target_idx 9 --task_mode classification --metric_name Accuracy_F1

# default
# hash id
python run.py make_hash --root ./exp --self_id 0 --mode default --dataset_path ./data/Wine_2_123_1.0/0/all/dataset.csv --id_idx 1
python run.py make_hash --root ./exp --self_id 1 --mode default --dataset_path ./data/Wine_2_123_1.0/1/all/dataset.csv --id_idx 1
...
# round 1
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id xyz --round 1 --dataset_path ./data/Wine_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode classification --metric_name Accuracy_F1
...
python run.py make_result --root ./exp --self_id 0 --task_id xyz --round 1 --dataset_path ./data/Wine_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode classification --metric_name Accuracy_F1

# round 2
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id xyz --round 2 --dataset_path ./data/Wine_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode classification --metric_name Accuracy_F1
...
python run.py make_result --root ./exp --self_id 0 --task_id xyz --round 2 --dataset_path ./data/Wine_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode classification --metric_name Accuracy_F1
...
# eval
python run.py make_eval --root ./exp --self_id 0 --task_id xyz --test_id uvw --round 2 --dataset_path ./data/Wine_2_123_1.0/0/test/dataset.csv --target_idx 9 --task_mode classification --metric_name Accuracy_F1
