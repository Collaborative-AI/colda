...
class Test_unread_request(Train_helper_function):
    ...
    def test_unread_request(self):
        ...
        set_default_data_path(default_mode=testing_data['default_mode'], default_model_name=testing_data['default_model_name'], default_file_path=testing_data['default_file_path'],
        ...
        # self.unread_output(update_all_notifications_data["unread request"])