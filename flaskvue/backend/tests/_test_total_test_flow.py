...
class Test_total_flow_APITestCase(Test_Helper_API_TestCase):

    def test_test_flow_between_two_users(self):
        ...
        self.unread_test_output_two_users_helper(task_id, test_id, list_content)
...
#         self.assertEqual(response.status_code, 200)
#         json_response_1 = json.loads(response.get_data(as_text=True))
#         self.assertEqual(json_response_1["unread test match id"]['check_dict'][str(test_id)], 1)
...
#         self.assertEqual(response.status_code, 200)
#         json_response_2 = json.loads(response.get_data(as_text=True))
#         self.assertEqual(json_response_2["unread test match id"]['check_dict'][str(test_id)], 0)
...
#         self.assertEqual(response.status_code, 200)
#         json_response_3 = json.loads(response.get_data(as_text=True))
#         self.assertEqual(json_response_3["unread test match id"]['check_dict'][str(test_id)], 0)
...
#         data = json.dumps({'output': output_content, 'test_id': test_id})
...
#         json_response = json.loads(response.get_data(as_text=True))
#         # check rounds
#         self.assertEqual(json_response["unread test output"]['check_dict'][str(test_id)], 1)
