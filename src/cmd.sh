...
# train
python run.py make_train --root ./exp --self_id 0 --task_id abc --round 1 --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --data_idx 2-8
python run.py make_train --root ./exp --self_id 1 --task_id abc --round 1 --from_id 0 --dataset_path ./data/BostonHousing_2_123_1.0/1/train/dataset.csv --data_idx 2-7
