...
train_file_path = f"/{local_path}/use_case_data/BostonHousing/BostonHousing_2_123_1.0/0/train/dataset.csv"
colda_instance.fit(
    max_round=2, 
    assistors=['xie2'], 
...
test_file_path = f"/{local_path}/use_case_data/BostonHousing/BostonHousing_2_123_1.0/0/test/dataset.csv"
