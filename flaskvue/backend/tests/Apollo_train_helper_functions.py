...
class Train_Helper_API_TestCase(unittest.TestCase):
    ...
    def unread_situation_two_users_helper(self, task_id, list_content, assistor_random_id_list, test_round):     
    ...
    def unread_output_two_users_helper(self, task_id, list_content, assistor_random_id_list, test_round):
    ...
    def stop_situation_train_two_users_prerequsite_helper(self, test_round):
        a = 1

    def stop_situation_train_two_users_helper(self, test_round):
        task_id, list_content, assistor_random_id_list = self.unread_request_two_users_helper()
    ...
    # def stop_train_two_users_helper(self, test_round):

    #     task_id, list_content, assistor_random_id_list = self.unread_match_id_two_users_helper()        
