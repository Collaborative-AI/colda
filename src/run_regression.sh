...
# baseline
python baseline.py --root ./data --data_name BostonHousing --task_id 123 --num_users 1 --match_rate 1 --task_mode regression --model_name linear --metric_name RMSE_R2
python baseline.py --root ./data --data_name BostonHousing --task_id 123 --num_users 2 --match_rate 1 --task_mode regression --model_name linear --metric_name RMSE_R2
python baseline.py --root ./data --data_name BostonHousing --task_id 123 --num_users 2 --match_rate 0.5 --task_mode regression --model_name linear --metric_name RMSE_R2

# local
python run.py make_train_local --root ./exp --self_id 0 --task_id abc --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --data_idx 2-8 --target_idx 9 --task_mode regression --model_name linear --metric_name RMSE_R2
python run.py make_test_local --root ./exp --self_id 0 --task_id abc --test_id def --dataset_path ./data/BostonHousing_2_123_1.0/0/test/dataset.csv --data_idx 2-8 --target_idx 9 --task_mode regression --metric_name RMSE_R2
...
# round 1
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id abc --round 1 --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name RMSE_R2
...
python run.py make_result --root ./exp --self_id 0 --task_id abc --round 1 --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name RMSE_R2

# round 2
# make residual
python run.py make_residual --root ./exp --self_id 0 --task_id abc --round 2 --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name RMSE_R2
...
python run.py make_result --root ./exp --self_id 0 --task_id abc --round 2 --dataset_path ./data/BostonHousing_2_123_1.0/0/train/dataset.csv --target_idx 9 --task_mode regression --metric_name RMSE_R2
...
# eval
python run.py make_eval --root ./exp --self_id 0 --task_id abc --test_id def --round 2 --dataset_path ./data/BostonHousing_2_123_1.0/0/test/dataset.csv --target_idx 9 --task_mode regression --metric_name RMSE_R2
