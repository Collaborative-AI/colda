...
python run.py make_test --root ./exp --self_id 1 --task_id abc --test_id def --round 1 --from_id 0 --dataset_path ./data/BostonHousing_2_123_1.0/1/all/dataset.csv --data_idx 2-7
...
# eval
python run.py make_eval --root ./exp --self_id 0 --task_id abc --test_id def --round 1 --dataset_path ./data/BostonHousing_2_123_1.0/0/test/dataset.csv --target_idx 9 --task_mode regression --metric_name MAD_RMSE_R2
